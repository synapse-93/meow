...
class GEEFeatureExtractorLive:
    ...
    def _safe_date(self, date_str):
        ...
        # GEE products are delayed; use at least 10 days before today.
    ...
    def extract_all_features(self, lat, lon, date_str, hour=12):
        ...
        try:
            ...
            features["NDVI"] = max(0, min(1, _safe_float(ndvi, 5000) / 10000.0))
        ...
        try:
            ...
            lst = lst_dict.get("LST_Day_1km") if lst_dict else None
            features["land_surface_temp"] = (_safe_float(lst, 14900) * 0.02) - 273.15
        except Exception as e:
        ...
        try:
            ...
            features["no2_column"] = max(0, _safe_float(no2, 0.00008))
        except Exception as e:
        ...
        try:
            ...
            aod = aod_dict.get("Optical_Depth_047") if aod_dict else None
            features["aod"] = abs(_safe_float(aod, 350)) / 1000.0
        except Exception as e:
        ...
        try:
            ...
            area_km2 = 3.14159 * (self.buffer_size / 1000.0) ** 2
            features["population_density"] = _safe_float(pop, 8000) / area_km2
        except Exception as e:
            print(f"  Population failed: {e}")
            features["population_density"] = 8000.0
            
        # Building density / built surface
        try:
            built = (
            ...
            features["building_density"] = _safe_float(built, 800.0)
        except Exception as e:
        ...
        try:
            ...
            features["road_density_proxy"] = min(nl / 50.0, 1.0)
        except Exception as e:
        ...
        try:
            ...
            features["tree_canopy"] = _safe_float(tree, 8.0) / 100.0
        except Exception as e:
        ...
        try:
            ...
            features["water_proximity"] = _safe_float(water, 2.0) / 100.0
        except Exception as e:
        ...
        features["urbanization_index"] = (
            0.4 * min(features["building_density"] / 1000.0, 1.0) +
        ...
        print(f"  LST: {features['land_surface_temp']:.2f}")
        print(f"  NO2 column: {features['no2_column']:.6f}")
        print(f"  AOD: {features['aod']:.3f}")
        print(f"  Pop density: {features['population_density']:.0f}/km²")
        print(f"  Pollution index: {features['pollution_index']:.2f}")
